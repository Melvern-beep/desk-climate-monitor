...
A desk monitor that displays temperature and humidity built on Arduino Nano.
...
| Sensor | SHT31-DIS | I2C 0x44, ±0.2°C, ±2%RH, 2.4–5.5V |
...
&#x20; blink\_baseline/    unmodified Arduino Blink, compile baseline

&#x20; blink\_millis/      non-blocking blink using millis()
